...
class AdminTagManagementTest extends TestCase
{
    ...
    public function test_viewing_a_tag_from_another_store_returns_not_found_even_when_a_global_tag_exists(): void
    {
        ...
        // AdminTagRepository::findInStore() correctly scopes to
        // (store_id = ? OR store_id IS NULL) AND id = ?, so a foreign
        // store's tag must never be returned here even when a global tag
        // also exists in the system.
