    ...
    private function seedAboutPage(Store $store, User $creator, ?int $templateId): void
    {
        ...
        $page->sections()->updateOrCreate(
            ...
            [
                ...
                'content' => [
                    'items' => [
                        ['title' => ['en' => 'Direct-source manufacturing', 'ar' => 'تصنيع من المصدر المباشر'], 'body' => ['en' => 'Every product is sourced directly from ISO-certified factories. No middlemen, no markups, no compromises.', 'ar' => 'كل منتج مصدره مباشرة من مصانع معتمدة بـ ISO. بلا وسطاء، بلا هوامش مبالغ فيها.']],
                        ['title' => ['en' => '3-stage quality testing', 'ar' => 'اختبار جودة بثلاث مراحل'], 'body' => ['en' => 'Products go through factory QC, an independent third-party lab, and a final in-house inspection before they ship.', 'ar' => 'تخضع المنتجات لمراقبة جودة المصنع، ومختبر طرف ثالث مستقل، وفحص داخلي نهائي.']],
                        ['title' => ['en' => 'Safety certified', 'ar' => 'معتمد سلامة'], 'body' => ['en' => 'All applicable products carry CE, FCC, or ASTM certifications depending on category.', 'ar' => 'جميع المنتجات المعنية تحمل شهادات CE أو FCC أو ASTM حسب الفئة.']],
                        ['title' => ['en' => 'Sustainable packaging', 'ar' => 'تغليف مستدام'], 'body' => ['en' => '100% recyclable packaging since 2022. We offset remaining carbon through verified reforestation credits.', 'ar' => 'تغليف قابل للتدوير 100% منذ 2022. نعوّض الكربون المتبقي عبر ائتمانات إعادة التشجير.']],
                        ['title' => ['en' => 'AI-assisted fit & match', 'ar' => 'مطابقة بمساعدة الذكاء الاصطناعي'], 'body' => ['en' => 'Our AI tools help you find the right size, style, or spec — transparently, with no personal data stored.', 'ar' => 'تساعدك أدواتنا الذكية على اختيار المقاس أو الطراز المناسب — بشفافية كاملة ودون حفظ بيانات شخصية.']],
                        ['title' => ['en' => 'Real customer reviews', 'ar' => 'تقييمات حقيقية من عملاء موثّقين'], 'body' => ['en' => 'Every review is from a verified purchaser. We do not filter negatives — you see everything.', 'ar' => 'كل تقييم صادر من مشترٍ موثّق. لا نحذف السلبيات — ترى كل شيء.']],
                    ],
                ],
